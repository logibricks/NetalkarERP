...
namespace Sciffer.Erp.Web.Controllers
{
    public class DebitNoteController : Controller
    {
        ...
        public DebitNoteController(ICreditDebitNoteService credit, IGenericService generic, ICurrencyService currency,
        ...
        [CustomAuthorizeAttribute("DN")]
        // GET: CreditNote
        public ActionResult Index()
        {
            ViewBag.doc = TempData["doc_num"];
            ViewBag.DataSource = _creditnoteservice.GetAll(2);
            return View();
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            ViewBag.category_list = new SelectList(_Generic.GetCategoryList(87), "document_numbring_id", "category");
