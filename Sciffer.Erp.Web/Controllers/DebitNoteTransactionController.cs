...
{
    public class DebitNoteTransactionController : Controller
    {
        ...
        public DebitNoteTransactionController(ICreditDebitNoteService credit, IGenericService generic, ICurrencyService currency, IItemTypeService itemtype,
        ...
        // GET: DebitNoteTransaction
        public ActionResult Index()
        {
            ViewBag.doc = TempData["doc_num"];
            ViewBag.DataSource = _creditnotetransservice.GetAll(2);
            return View();
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            ViewBag.category_list = new SelectList(_Generic.GetCategoryListByModule("DN"), "document_numbring_id", "category");
        ...
        {
            var issaved = "";
            fin_credit_debit_note.credit_debit_id = 2;
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.GST_CustomerType_List = new SelectList(_Generic.GetGSTCustomerVendorType(), "gst_customer_type_id", "gst_customer_type_name");
            ViewBag.tds_list = _TdsCodeService.GetAll().Select(a => new { a.tds_code_id, tds_code = a.tds_code + "/" + a.tds_code_description }).ToList();
            ViewBag.cancellationreasonlist = new SelectList(_Generic.GetCANCELLATIONReason("DN"), "cancellation_reason_id", "cancellation_reason");
            return View(fin_credit_debit_note);
        }
        ...
        public CrystalReportPdfResult Pdf(int id)
        {
            ...
            try
            {
                ...
                rd.SetParameterValue("p4", "Debit Note");
