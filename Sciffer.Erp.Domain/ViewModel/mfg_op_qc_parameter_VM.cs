...
{
    public class mfg_op_qc_parameter_VM
    {
        ...
        public List<string> mfg_op_qc_parameter_list_id { get; set; }
        ...
        public virtual IList<mfg_op_qc_parameter_list> mfg_op_qc_parameter_list { get; set; }
