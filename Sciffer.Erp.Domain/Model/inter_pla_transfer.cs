...
{
    public class inter_pla_transfer
    {
        [Key]
        ...
        public virtual ICollection<inter_pla_transfer_detail> inter_pla_transfer_detail { get; set; }
        public virtual ICollection<inter_pla_transfer_detail_tag> inter_pla_transfer_detail_tag { get; set; }
